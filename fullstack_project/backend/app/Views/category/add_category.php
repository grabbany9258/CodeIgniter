                        ...
                        <form method="post" action="<?= base_url('category/create') ?>">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_name" class="form-control mb-4" id="exampleInputEmail1" placeholder="Enter Product Name" value="<?php echo old('category_name') ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_details" class="form-control mb-4" id="exampleInputEmail1" placeholder="Enter Product Name" value="<?php echo old('category_details') ?>" />
