...
<html lang="en">
   ...
   <body>
      <section class="mt-3">
         ...
         <h4 class="text-center" style="color:green"> Bill Receipt in Codeigniter </h4>
         <h6 class="text-center" style="color:red"><b>Developed By Improve Programming Logic Channel</b></h6>
         <div class="row">
   ...
   $(document).ready(function(){
     $('#vegitable').change(function() {
      var id = $(this).find(':selected')[0].id;
       $.ajax({
          method:'POST',
          url:"<?php echo site_url('Emp/priceGet'); ?>",
          data:{id:id},
          dataType:'json',
